	   ...
	   private WebDriverWait wait;
		...
		public void series_set() throws InterruptedException
		{
			...
			driver.switchTo().defaultContent();
	    	 ...
	    	 try {
	    		    WebElement Human_fetus_72 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//table[@class='cdk-table nb-tree-grid']//tr[6]")));
	    		    Human_fetus_72.click();
	    		    System.out.println("Human_fetus clicked successfully.");
	    		    Thread.sleep(2000);
	    		} catch (Exception e) {
	    		    System.out.println("Human_fetus not clicked: " + e.getMessage());
	    		}
	    	 checkConsoleLog();
	    	 ...
	    	 try {
	    		    ...
	    		    Brain.click();
	    		    System.out.println(" Brain option clicked successfully.");
	    		    Thread.sleep(2000);
	    		} catch (Exception e) {
	    		    System.out.println("Brain option not clicked: " + e.getMessage());
	    		}
	    	 checkConsoleLog();
	    	 
	    	 try {
	 		    WebElement brain = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//table[@class='cdk-table nb-tree-grid']//tr[47]//td[3]")));
	 		    brain.click();
	    	 ...
	    	 try {
	  		    WebElement section = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//span[text()='256'])[1]")));
	  		    section.click();
	  		    System.out.println("section 256 clicked successfully.");
	  		    Thread.sleep(2000);
	  		} catch (Exception e) {
	  		    System.out.println("section 256 not clicked: " + e.getMessage());
	  		}
		  ...
		  private void Cell_API()
		    {
		    	...
		    	Response response1 = RestAssured
		    		    ...
		    		    .basic("admin", "admin")
		    		    .when()
		    		    .get("https://apollo2.humanbrain.in/BR/AppAtlasRegisteration/24279/");
		      int statusCode1 = response1.getStatusCode();
		      if (statusCode1 == 200) {
		    ...
		    Response response4 = RestAssured
			  ...
			  //Annotated tile list
			  String jsonBody1 = "{\"bid\":223,\"sec\":256,\"annotationtype\":3,\"seriestype\":\"NISSL\",\"tilesize_ip\":\"512\",\"tilesize_op\":512}";
			        ...
			        //WIP tile list
			        String jsonBody2 = "{\"bid\":223,\"sec\":256,\"annotationtype\":3,\"seriestype\":\"NISSL\",\"tilesize_ip\":\"512\",\"tilesize_op\":512}";
				     ...
				     //AG tile list
				        String jsonBody3 = "{\"bid\":223,\"sec\":256,\"annotationtype\":3,\"seriestype\":\"NISSL\",\"tilesize_ip\":\"512\",\"tilesize_op\":512}";
